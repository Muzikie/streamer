...
const {
	...
	EVENT_NAME_ANCHOR_STREAMED,
	EVENT_NAME_ANCHOR_INCOME_RECLAIMED,
...
const EVENT_TOPIC_MAPPINGS_BY_MODULE = {
	...
	[MODULE_NAME_ANCHOR]: {
		...
		[EVENT_NAME_ANCHOR_STREAMED]: ['transactionID', 'senderAddress'],
		[EVENT_NAME_ANCHOR_INCOME_RECLAIMED]: ['transactionID', 'senderAddress'],
	},
	[MODULE_NAME_PROFILE]: {
